...
<html lang="en">
  <head>
    ...
    <title>EcommerceProject-Login</title>
  ...
  <body>
    ...
    <nav class="mobilemenu">
		...
		<img src="assets/img/logo.png"  class="mobilemenulogo"/>
			...
			<a style="text-decoration:none;" href="login.php"><li class="account" id="login"><i class="bi bi-person-fill" id="acount" style="color:#ed4c07"></i><span  id="active">login</span></li></a>
