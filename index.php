...
<html lang="en">
  <head>
    ...
    <title>EcommerceProject-Home</title>
  ...
  <img src="assets/img/logo.png"  class="mobilemenulogo"/>
   ...
   <section class="hero-section">
	...
	<div class="content-header">
		<h4>All the assets you need, in one place</h4>
		<p class="content-subtitle">Shop clothes, accessories, and more from independent sellers around the world.</p>
	</div>
	<div class="content-searchinput">
		<input  type="text" placeholder="search product by name"/>
		<button class="seacrchbtn"><i class="bi bi-search"></i></button>
	</div>
	<div class="product-category">
	<div class="row">
		<p class="column1 columns">
			Mens&numsp;Outfit
</p>
		<p class="column2 columns">
			Men&numsp;Shoes
</p>
		<p class="column3 columns">
			Women&numsp;Outfit
</p>
		<p class="column4 columns">
			Women&numsp;Shoes
</p>
		<p class="column5 columns">
		Kid&numsp;Outfit
</p>
	</div>
	</div>
